#!/usr/bin/env python3
"""
HTTP server untuk aplikasi mirroring.
Endpoint:
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path == "/":
            return self._send(200, "text/html", (CLIENT_DIR / "index.html").read_bytes())

        if self.path == "/app.js":
            return self._send(
                200,
                "application/javascript",
                (CLIENT_DIR / "app.js").read_bytes(),
            )
